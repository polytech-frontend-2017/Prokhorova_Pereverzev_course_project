        ...
        return(
				<div>
					...
					<div className = {'pultik'}>
							<button className = {'red'} onClick = {this.choose.bind(this,'red')} disabled = {this.state.setActive && this.state.isDisable}>{'Aka'}</button>
							<button className = {'blue'} onClick = {this.choose.bind(this,'blue')} disabled = {this.state.setActive && this.state.isDisable}>{'Shiro'}</button>
							<button className = {'changeSelect'} onClick = {this.change} disabled={this.state.setActive}>{'Change'}</button>
					</div>
						:
